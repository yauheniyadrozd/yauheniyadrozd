...
### [Code Clarity Analyzer API](https://github.com/YauheniyaDrozd/code-analyzer-api)
A Flask REST API that analyzes Python code quality and provides actionable feedback with scoring system.
- **Tech**: Python, Flask, SQLite, REST API
- **Features**: File upload, code analysis, scoring system, persistent storage
- Built for code review automation and developer workflows
